        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <div class="form-row">
                    ...
                    <div class="col"> <label class="form-control-label">Address:</label>
                ...
                <div class="form-row">
                    ...
                    <div class="col"> <label class="form-control-label">State:</label>
                ...
                <div class="form-row">
                    ...
                    <div class="col"><label class="form-control-label">Country:</label>
            ...
            <div class="card-body card-block">
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        <button type="button" onclick="object.resetParams().setForm('#customerAddressForm').load();" name="update" class="btn btn-primary btn-lg">
