        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <div class="form-row">
                    ...
                    <div class="col"><label class="form-control-label">Title :</label>
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        <button type="button" onclick="getContent(); object.resetParams().setForm('#CMSForm').load();" name="update" class="btn btn-primary btn-lg">
