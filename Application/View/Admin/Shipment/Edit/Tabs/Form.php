            ...
            <div class="card-body card-block">
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="text" name="shipment[methodId]" disabled="disabled" value="<?php if ($shipment->methodId) {
                                                                                                    echo $shipment->methodId;
                                                                                                } else {
                                                                                                    echo 'Auto';
                                                                                                } ?>" class="form-control">
                ...
                <div class="form-row">
                    ...
                    <div class="col"> <label class="form-control-label">Amount:</label>
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        <button type="button" onclick="object.resetParams().setForm('#shipmentForm').load();" name="update" class="btn btn-primary btn-lg">
