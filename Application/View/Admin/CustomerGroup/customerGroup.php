<div class="section__content section__content--p30">
    <div class="container-fluid">
        ...
        <a onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('form', 'CustomerGroup', [], true) ?>').resetParams().load(); " class="btn btn-outline-primary btn-sm">Add customer Group</a>
