            ...
            <div class="card-body card-block">
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="text" name="admin[adminId]" value="<?php if ($admin->adminId) {
                                                                            echo $admin->adminId;
                                                                        } else {
                                                                            echo 'Auto';
                ...
                <div class="form-row">
                    ...
                    <div class="col"> <label class="form-control-label">Password:</label>
                        <input type="password" id="password" name="admin[password]" value="<?php echo $admin->password; ?>" class="form-control"></div>
                </div>
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        <button type="button" onclick="object.resetParams().setForm('#adminForm').load();" name="update" class="btn btn-primary btn-lg">
