    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-row">
                ...
                <div class="col"> <label class="form-control-label">Discount:</label>
            ...
            <div class="form-row">
                ...
                <div class="col"> <label class="form-control-label">Description:</label>
            ...
            <div class="card-body card-block">
                <div class="form-group">
                    <button type="button" onclick="object.resetParams().setForm('#productForm').load();" name="update" class="btn btn-primary btn-lg">
