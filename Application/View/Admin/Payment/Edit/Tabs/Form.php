            ...
            <div class="card-body card-block">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="text" name="payment[paymentId]" disabled="disabled" value="<?php if ($payment->methodId) {
                                                                                                    echo $payment->methodId;
                                                                                                } else {
                                                                                                    echo 'Auto';
                                                                                                } ?>" class="form-control">
                ...
                <div class="card-body card-block">
                    <div class="form-group">
                        <button type="button" onclick="object.resetParams().setForm('#paymentForm').load();" name="update" class="btn btn-primary btn-lg">
